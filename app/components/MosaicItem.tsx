            ...
            >
                ...
                <div className={`relative w-full aspect-[1]`}>
                    <Image
                        ...
                        loading="lazy"
                        className="object-contain transition-transform duration-700 ease-in-out group-hover:scale-[2] group-hover:z-10"
                    />
                </div>
                ...
                {/* <div className="w-full h-full object-cover rounded-md shadow-md overflow-hidden">
                    <Image
                        ...
                        sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                        loading="lazy"
                        className="object-contain transition-transform duration-700 ease-in-out group-hover:scale-[2.5] group-hover:z-10"
                    />
                </div> */}
