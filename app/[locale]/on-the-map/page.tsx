    ...
    <div className="main-container flex flex-wrap min-h-screen overflow-auto">
      ...
      <div className="flex flex-wrap justify-center w-full text-slate-800 px-1 mb-8 mt-2 sm:w-full sm:px-1 sm:my-1 md:w-2/3 md:px-1 md:my-1 lg:px-1 lg:my-1 xl:w-2/5 ">
        <div className="flex flex-col w-2/3 mx-6 mt-20 text-sm">
          <h2 className="uppercase mt-8">{t("title")}</h2>

          <p className="mt-4">{t("intro")}</p>

          <p className="mt-2">{t("equality")}</p>

          <p className="mt-2">
            {t("mosaic-promo")}{" "}
            <a href="/mosaic" className="underline">
              {t("visit-mosaic")}
            </a>
          </p>

          <p className="mt-2">{t("updates")}</p>

          <hr className="my-6 border-t border-slate-300" />

          <h3 className="mt-4 font-semibold">{t("professionals-title")}</h3>

          <p className="mt-2">{t("professionals-desc")}</p>
          ...
          <h3 className="mt-4 font-semibold">{t("get-started")}</h3>
          <p className="mt-2">
            {t("publish-help")}{" "}
            <a
          ...
          <p className="mt-2">
            <strong>Art Now Database</strong> {t("mission")}{" "}
            <em>{t("mission-tagline")}</em>.
          </p>
        </div>

        <div className="results-container overflow-y-auto sm:mt-4"></div>
